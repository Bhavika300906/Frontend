          ...
          <div className="navbar-nav ms-auto p-4 p-lg-0">
            ...
            <div className="nav-item dropdown">
              ...
              <div className="dropdown-menu bg-light m-0">
                <NavLink to="/admin/services/mng" className="dropdown-item"> Service Manage</NavLink>
                <NavLink to="/admin/services/add" className="dropdown-item">Service Add</NavLink>
              </div>
            </div>
            <div className="nav-item dropdown">
              <a href="#" className="nav-link dropdown-toggle" data-bs-toggle="dropdown">Team</a>
              <div className="dropdown-menu bg-light m-0">
                <NavLink to="/admin/team/mng" className="dropdown-item">Team Manage</NavLink>
                <NavLink to="/admin/team/add" className="dropdown-item">Team Add</NavLink>
              </div>
            </div>
